  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        sm: "0px 8px 40px 0px #000000",
        md: "0px 8px 18px 0px #ad5dfe",
        lg: "0px 20px 40px 0px #757575",
        xl: "0px 20px 40px 0px #5c27c0",
        "2xl": "0px 4px 24px 0px #000000",
        "3xl": "0px 2px 20px 0px #000000",
        "4xl": "0px -4px 14px 0px #000000",
        "5xl": "0px 4px 14px 0px #000000",
      },
      fontFamily: {
